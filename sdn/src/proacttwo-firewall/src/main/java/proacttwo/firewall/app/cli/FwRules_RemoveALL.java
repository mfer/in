 ...
 */
@Command(scope = "proacttwoFirewall", name = "fwremove-AllRules", description = "Remove todas as regras criadas pelo firewall")
public class FwRules_RemoveALL extends AbstractShellCommand {
    ...
    protected void execute() {
         ...
         * implementada em nossa classe principal (ProacttwoFirewall.java, linha 202).
